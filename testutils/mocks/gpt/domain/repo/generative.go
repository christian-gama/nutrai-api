...
func (_m *Generative) ChatCompletion(ctx context.Context, input []*gpt.Message) (*gpt.Message, error) {
	ret := _m.Called(ctx, input)

	var r0 *gpt.Message
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []*gpt.Message) (*gpt.Message, error)); ok {
		return rf(ctx, input)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []*gpt.Message) *gpt.Message); ok {
		r0 = rf(ctx, input)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, []*gpt.Message) error); ok {
		r1 = rf(ctx, input)
	} else {
		r1 = ret.Error(1)
	}
