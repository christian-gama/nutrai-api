...
func (_m *Paginator) SetLimit(limit int) queryer.Paginator {
	ret := _m.Called(limit)

	var r0 queryer.Paginator
	if rf, ok := ret.Get(0).(func(int) queryer.Paginator); ok {
		r0 = rf(limit)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(queryer.Paginator)
		}
	}
...
func (_m *Paginator) SetPage(page int) queryer.Paginator {
	ret := _m.Called(page)
